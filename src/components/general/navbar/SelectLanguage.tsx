...
export const SelectLanguage = ({aos, style}: {aos?:string, style?:string}) => {
    ...
    return(
        <div className='relative text-lg flex rounded-lg'>
            <div data-aos={aos} className={`bg-gray-100 dark:bg-gray-700 dark:border-gray-500 border dark:text-gray-100 py-2.5 sm:py-1.5 px-4 rounded-lg shadow-sm cursor-pointer ${style}`} onClick={() => {
                setOpen(!open)
            }}>
            ...
            <div
                className={`z-[1000] absolute w-full bg-gray-100 dark:bg-gray-700 dark:text-gray-200 rounded-lg py-1.5 px-2 border dark:border-gray-500 top-[120%] flex flex-col sm:items-start items-center justify-center gap-2 ${open ? '' : 'hidden'} ${style}`}>
                <p onClick={() => {
